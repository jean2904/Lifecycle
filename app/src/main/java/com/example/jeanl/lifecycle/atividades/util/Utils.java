...
package com.example.jeanl.lifecycle.atividades.util;
...
public class Utils {
    ...
    private static com.example.jeanl.lifecycle.atividades.util.StatusTracker mStatusTracker = com.example.jeanl.lifecycle.atividades.util.StatusTracker.getInstance();
